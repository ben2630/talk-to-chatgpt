// This function will say the given text out loud using the Google Cloud Text-to-Speech API
function CN_SayOutLoud(text) {
    ...
    xhr.onload = function() {
        var audioContent = xhr.response.audioContent;
        audio.src = 'data:audio/wav;base64,' + audioContent;
    };
    xhr.onerror = function() {
        console.log('Error making request to Google Cloud Text-to-Speech API');
    };
    xhr.send(JSON.stringify({
        ...
        voice: {
            languageCode: 'en-US', // specify your desired language
            name: 'en-US-Wavenet-D', // specify your desired voice
        },
        audioConfig: {
            audioEncoding: 'LINEAR16',
            speakingRate: CN_TEXT_TO_SPEECH_RATE,
            pitch: CN_TEXT_TO_SPEECH_PITCH
        }
    }));
